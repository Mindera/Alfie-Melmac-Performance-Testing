    ...
    override fun createTestPlanWithVersion(
        ...
        val databaseDevice =
            if (os.operSysName.equals("ios", ignoreCase = true)) {
                deviceRepository.findBySerialNumber(device.deviceSerialNumber ?: throw IllegalArgumentException("Device serial number cannot be null"))
            } else {
        ...
        val existingAppVersion = appVersionRepository.findByAppIdAndVersion(app.appId!!, appVersion)
        val appVersionDef =
        ...
        val savedTestPlanVersion = newVersion.copy(testPlanVersionId = savedTestPlanVersionId)
                ...
                request.executionTypeParameters.map {
                    ...
                    TestExecutionTypeParameter(
                            ...
                            executionTypeParameterExecutionTypeParameterId =
                                    parameter.executionTypeParameterExecutionTypeParameterId,
                            testPlanVersionTestPlanVersionId =
                                    savedTestPlanVersion.testPlanVersionId!!
                    )
                }
        ...
        println("Saving TestSuiteVersionPlan for testSuiteVersionId: ${request.testSuiteVersionId}")
        val testSuitePlanVersion =
                TestSuiteVersionPlan(
                        testSuiteVersionTestSuiteVersionId = request.testSuiteVersionId,
                        testPlanVersionTestPlanVersionId = savedTestPlanVersion.testPlanVersionId!!,
                        order =
        ...
        return TestPlanVersionResponseDTO(
                ...
                executionTypeExecutionTypeId = savedTestPlanVersion.executionTypeExecutionTypeId,
                thresholds =
