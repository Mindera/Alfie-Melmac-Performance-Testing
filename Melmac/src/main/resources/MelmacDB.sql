...
CREATE TABLE Device (DeviceID int IDENTITY NOT NULL, DeviceName varchar(255) NOT NULL, DeviceSerialNumber varchar(255) NULL UNIQUE, OSVersionOSVersionID int NOT NULL, PRIMARY KEY (DeviceID));
